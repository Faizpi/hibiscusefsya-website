        ...
        return [
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        'method' => 'GET',
                        'path' => '/api/v1/dashboard/daily-report/pdf',
                        'title' => 'Laporan Harian (PDF Download)',
                        'description' => 'Download laporan harian dalam format PDF. Sama persis dengan format PDF di website (landscape A4, lampiran gambar embedded, koordinat, badge status). File binary PDF langsung di-download.',
                        'auth' => true,
                        'params' => [
                            ['name' => 'date', 'type' => 'date', 'required' => false, 'description' => 'Tanggal laporan (YYYY-MM-DD). Default: hari ini'],
                        ],
                    ...
                    [
                        ...
                        'body' => [
                            ...
                            ['name' => 'transaction_type', 'type' => 'string', 'required' => true, 'description' => 'Tipe: all, penjualan, pembelian, biaya, kunjungan'],
                            ['name' => 'status_filter', 'type' => 'string', 'required' => false, 'description' => 'Filter status: all, Pending, Approved, Rejected, Canceled, Lunas (default: all)'],
                            ['name' => 'gudang_id', 'type' => 'integer', 'required' => false, 'description' => 'Filter by gudang ID'],
                            ['name' => 'biaya_jenis', 'type' => 'string', 'required' => false, 'description' => 'Filter jenis biaya: masuk, keluar (hanya untuk tipe biaya)'],
                            ['name' => 'tujuan_filter', 'type' => 'string', 'required' => false, 'description' => 'Filter tujuan kunjungan (hanya untuk tipe kunjungan)'],
                            ['name' => 'export_format', 'type' => 'string', 'required' => false, 'description' => 'Format: excel atau pdf (default: excel)'],
                            ['name' => 'sales_id', 'type' => 'integer', 'required' => false, 'description' => 'Filter by sales user ID'],
                        ],
                        'response' => 'Binary file download (PDF atau XLSX, tergantung export_format)',
                    ],
                ],
            ],
            // ===================== GUDANG =====================
            [
                ...
                'items' => [
                    ...
                    [
                        'method' => 'GET',
                        'path' => '/api/v1/gudang/stok/export',
                        'title' => 'Export Stok (Excel)',
                        'description' => 'Export data stok gudang ke file Excel. Format sama persis dengan website (header styled, freeze panes, auto-size kolom). Role: admin, spectator, super_admin.',
                        'auth' => true,
                        'roles' => ['admin', 'spectator', 'super_admin'],
                        'params' => [
                            ['name' => 'gudang_id', 'type' => 'integer', 'required' => true, 'description' => 'ID gudang yang akan di-export stoknya'],
                        ],
                ...
                'items' => [
                    ...
                    [
                        ...
                        'body' => [
                            ...
                            ['name' => 'kode_kontak', 'type' => 'string', 'required' => false, 'description' => 'Kode kontak (auto-generate jika kosong, format: KT00001)'],
                            ['name' => 'no_telp', 'type' => 'string', 'required' => false, 'description' => 'Nomor telepon'],
                            ['name' => 'email', 'type' => 'string', 'required' => false, 'description' => 'Email'],
                            ['name' => 'pin', 'type' => 'string', 'required' => false, 'description' => 'PIN Customer (6 digit)'],
                            ['name' => 'alamat', 'type' => 'string', 'required' => false, 'description' => 'Alamat'],
                    ...
                    [
                        ...
                        'body' => [
                            ['name' => 'nama', 'type' => 'string', 'required' => true, 'description' => 'Nama kontak'],
                            ['name' => 'kode_kontak', 'type' => 'string', 'required' => false, 'description' => 'Kode kontak'],
                            ['name' => 'no_telp', 'type' => 'string', 'required' => false, 'description' => 'Nomor telepon'],
                            ['name' => 'email', 'type' => 'string', 'required' => false, 'description' => 'Email'],
                            ['name' => 'pin', 'type' => 'string', 'required' => false, 'description' => 'PIN Customer (6 digit)'],
                            ['name' => 'alamat', 'type' => 'string', 'required' => false, 'description' => 'Alamat'],
                ...
                'items' => [
                    ...
                    [
                        ...
                        'body' => [
                            ...
                            ['name' => 'no_telepon', 'type' => 'string', 'required' => false, 'description' => 'Nomor telepon pelanggan'],
                            ...
                            ['name' => 'tipe_harga', 'type' => 'string', 'required' => false, 'description' => 'Tipe harga: retail atau grosir (default: retail)'],
            ...
            [
                ...
                'items' => [
                    [
                        ...
                        'params' => [
                            ['name' => 'status', 'type' => 'string', 'required' => false, 'description' => 'Filter: Pending, Approved, Canceled'],
                            ['name' => 'jenis', 'type' => 'string', 'required' => false, 'description' => 'Filter berdasarkan jenis biaya'],
                            ['name' => 'per_page', 'type' => 'integer', 'required' => false, 'description' => 'Jumlah per halaman (default: 20)'],
                        ],
                    ...
                    [
                        ...
                        'roles' => ['user', 'admin', 'super_admin'],
                        'body' => [
                            ['name' => 'jenis_biaya', 'type' => 'string', 'required' => false, 'description' => 'Jenis biaya (default: keluar)'],
                            ['name' => 'tgl_transaksi', 'type' => 'date', 'required' => true, 'description' => 'Tanggal transaksi (YYYY-MM-DD)'],
                            ['name' => 'cara_pembayaran', 'type' => 'string', 'required' => false, 'description' => 'Cara pembayaran'],
                            ['name' => 'bayar_dari', 'type' => 'string', 'required' => true, 'description' => 'Sumber pembayaran'],
                ...
                'items' => [
                    ...
                    [
                        ...
                        'body' => [
                            ...
                            ['name' => 'gudang_id', 'type' => 'integer', 'required' => false, 'description' => 'ID gudang (default: gudang aktif user)'],
                            ['name' => 'tgl_kunjungan', 'type' => 'date', 'required' => true, 'description' => 'Tanggal kunjungan (YYYY-MM-DD)'],
                            ['name' => 'tujuan', 'type' => 'string', 'required' => true, 'description' => 'Tujuan kunjungan. Nilai: Pemeriksaan Stock, Penagihan, Promo Gratis, Promo Sample'],
                            ['name' => 'koordinat', 'type' => 'string', 'required' => false, 'description' => 'Koordinat GPS'],
                            ['name' => 'memo', 'type' => 'string', 'required' => false, 'description' => 'Catatan'],
                            ['name' => 'sales_nama', 'type' => 'string', 'required' => false, 'description' => 'Nama sales (nullable)'],
                            ['name' => 'sales_no_telepon', 'type' => 'string', 'required' => false, 'description' => 'No. Telepon sales (nullable)'],
                            ['name' => 'sales_alamat', 'type' => 'string', 'required' => false, 'description' => 'Alamat sales (nullable)'],
                            ['name' => 'items', 'type' => 'array', 'required' => false, 'description' => 'Produk yang dibawa. WAJIB untuk tujuan: Pemeriksaan Stock, Promo Gratis, Promo Sample. Untuk Promo Gratis/Sample, stok divalidasi.'],
                            ['name' => 'items[].produk_id', 'type' => 'integer', 'required' => true, 'description' => 'ID produk'],
                            ['name' => 'items[].jumlah', 'type' => 'number', 'required' => true, 'description' => 'Jumlah (alias: kuantitas)'],
