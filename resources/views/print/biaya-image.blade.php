...
<tr><td class="label">Jatuh Tempo</td><td class="colon">:</td><td class="value">{{ $biaya->tgl_jatuh_tempo ? $biaya->tgl_jatuh_tempo->format('d/m/Y') : '-' }}</td></tr>
...
<tr><td class="lbl"><b>Jumlah</b></td><td class="val"><b>Rp {{ number_format($item->jumlah,0,',','.') }}</b></td></tr>
</table>
@endforeach
