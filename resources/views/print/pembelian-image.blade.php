...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td class="colon">:</td>
            <td class="value">{{ $pembelian->metode_pembayaran ?? 'Net 30' }}</td>
        </tr>
        <tr>
    ...
    @foreach($pembelian->items as $item)
        ...
        <table>
            <tr>
                <td class="lbl">Qty</td>
                <td class="val">{{ $item->kuantitas }} Pcs</td>
            </tr>
            <tr>
    ...
    <table>
        <tr>
            ...
            <td class="val">{{ format_rupiah($pembelian->items->sum('jumlah_baris')) }}</td>
        </tr>
