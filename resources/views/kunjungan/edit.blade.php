        ...
        <form action="{{ route('kunjungan.update', $kunjungan->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ optional($kunjungan->gudang)->nama_gudang ?? '-' }}" readonly>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" class="form-control @error('sales_no_telepon') is-invalid @enderror"
                                    id="sales_no_telepon" name="sales_no_telepon"
                                    value="{{ old('sales_no_telepon', $kunjungan->sales_no_telepon) }}"
                    ...
                    <button type="button" class="btn btn-outline-primary btn-sm mt-2 mb-3" id="btn-add-produk">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="memo" name="memo"
                            rows="3">{{ old('memo', $kunjungan->memo) }}</textarea>
                    </div>
