                ...
                <form action="{{ route('kontak.update', $kontak->id) }}" method="POST">
                    ...
                    @if(in_array(auth()->user()->role, ['user', 'admin']))
                        ...
                        <div class="alert alert-info">
                            <i class="fas fa-info-circle"></i> Anda hanya dapat mengubah PIN customer. Hubungi Super Admin untuk mengubah data lainnya.
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label><strong>Nama Kontak</strong></label>
                                <div class="p-2 bg-light border rounded">{{ $kontak->nama }}</div>
                            </div>
                            <div class="col-md-6">
                                <label><strong>No. Telepon</strong></label>
                                <div class="p-2 bg-light border rounded">{{ $kontak->no_telp ?? '-' }}</div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('no_telp') is-invalid @enderror" id="no_telp"
                                        name="no_telp" value="{{ old('no_telp', $kontak->no_telp) }}" placeholder="628xxxxxxxxxx">
