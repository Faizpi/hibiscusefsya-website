                ...
                <form action="{{ route('kontak.store') }}" method="POST">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('kode_kontak') is-invalid @enderror"
                                    id="kode_kontak" name="kode_kontak" value="{{ old('kode_kontak') }}"
                                    placeholder="Kosongkan untuk auto-generate">
                                <small class="form-text text-muted">Contoh: KT00001, CUST-001, dll. Kosongkan untuk
                                    auto-generate.</small>
                                @error('kode_kontak')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">Format: 628xxxxxxxxxx (tanpa +, spasi, atau strip). No.
                                    Telp akan menjadi username login customer</small>
                                @error('no_telp')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('diskon_persen') is-invalid @enderror"
                            id="diskon_persen" name="diskon_persen" value="{{ old('diskon_persen', 0) }}" min="0" max="100"
                            step="0.01">
                        @error('diskon_persen')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
