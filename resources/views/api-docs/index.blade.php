    ...
    <div class="main">
        ...
        <div class="hero">
            ...
            <div class="hero-tags">
                ...
                <span class="hero-tag"><i class="fas fa-cube"></i>
                    {{ collect($docs['endpoints'])->sum(function ($g) {
    return count($g['items']); }) }} Endpoints</span>
            </div>
        </div>
        ...
        <div class="info-card" id="authentication">
            ...
            <div class="code-block"><span class="c-comment">// Header yang harus dikirim di setiap request</span>
                <span class="c-key">Authorization</span>: <span class="c-val">Bearer</span> <span
                    class="c-token">{token_dari_login}</span>
            </div>
                    ...
                    <div class="ep-card" id="ep-{{ $gi }}-{{ $ei }}"
                        ...
                        <div class="ep-body">
                                        ...
                                        <tbody>
                                            @foreach($ep['params'] as $param)
                                                <tr>
                                                    ...
                                                    <td>@if($param['required'] ?? false)<span class="pr">WAJIB</span>@else<span
                                                    class="po">opsional</span>@endif</td>
                            ...
                            @if(!empty($ep['response']))
                                <div>
                                    <div class="section-title"><i class="fas fa-check-circle" style="color:var(--green)"></i>
                                        Response (200 OK)</div>
                                    <div class="resp-block"><button class="cp-btn" onclick="copyCode(this)"><i
                                                class="far fa-copy"></i> Copy</button>{!! formatJson($ep['response']) !!}</div>
                                </div>
                            @endif
                        </div>
                    </div>
