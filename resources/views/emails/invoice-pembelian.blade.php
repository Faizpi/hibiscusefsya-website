...
<head>
    ...
    <title>Permintaan Pembelian - {{ $transaksi->staf_penyetuju }}</title>
    <style>
        body {
...
<body>
    @php
        ...
        $kenaPajak = max(0, $subtotal - ($transaksi->diskon_akhir ?? 0));
        ...
        <div class="invoice-body">
            <div class="info-card">
                ...
                <div class="info-row">
                    ...
                    <span class="value">{{ $transaksi->urgensi ?? 'Normal' }}</span>
                </div>
                <div class="info-row">
            ...
            <div class="info-card">
                <div class="info-card-title">👤 Detail Pembelian</div>
                <div class="info-row">
