...
<body>
    ...
    <div class="invoice-container">
        <div class="invoice-header">
            ...
            <h1>{{ strtolower($biaya->jenis_biaya ?? 'keluar') === 'masuk' ? 'Bukti Pemasukan' : 'Bukti Pengeluaran' }}
            </h1>
        ...
        <div class="invoice-body">
            <div class="info-card">
                ...
                <div class="info-row">
                    ...
                    <span
                        class="value">{{ strtolower($biaya->jenis_biaya ?? 'keluar') === 'masuk' ? 'Biaya Masuk' : 'Biaya Keluar' }}</span>
                </div>
                <div class="info-row">
