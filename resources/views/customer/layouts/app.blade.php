...
<head>
    ...
    <style>
        * {
        ...
        .nav-dropdown-info .name {
            font-size: 0.92rem;
            font-weight: 600;
            color: var(--gray-900);
        }

        .nav-dropdown-info .phone {
            font-size: 0.8rem;
            color: var(--gray-500);
            margin-top: 2px;
        }
        ...
        .mobile-overlay-user .info .name {
            font-size: 1rem;
            font-weight: 600;
            color: var(--gray-900);
        }

        .mobile-overlay-user .info .phone {
            font-size: 0.85rem;
            color: var(--gray-500);
        }
        ...
        <div class="mobile-overlay" id="mobileOverlay">
            <div class="mobile-overlay-header">
                ...
                <button class="mobile-overlay-close"
                    onclick="document.getElementById('mobileOverlay').classList.remove('open')">&times;</button>
            </div>
