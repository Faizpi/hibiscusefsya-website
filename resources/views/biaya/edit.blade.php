                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('bayar_dari') is-invalid @enderror" name="bayar_dari"
                                    required>
                        ...
                        <div class="col-md-8">
                            <div class="alert alert-info mb-0">
                                ...
                                @if($biaya->gudang)
                                    <br><i class="fas fa-warehouse"></i> Gudang:
                                    <strong>{{ $biaya->gudang->nama_gudang }}</strong>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="d-flex align-items-stretch">
                                    <div class="flex-grow-1">
                                        <select class="form-control @error('penerima') is-invalid @enderror"
                                            id="kontak-select" name="penerima">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('alamat_penagihan') is-invalid @enderror"
                                    ...
                                    rows="2">{{ old('alamat_penagihan', $biaya->alamat_penagihan) }}</textarea>
                        ...
                        <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control @error('tgl_transaksi') is-invalid @enderror"
                                            ...
                                            value="{{ old('tgl_transaksi', $biaya->tgl_transaksi->format('Y-m-d')) }}"
                                            required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('cara_pembayaran') is-invalid @enderror"
                                            ...
                                            <option value="Transfer Bank" {{ old('cara_pembayaran', $biaya->cara_pembayaran) == 'Transfer Bank' ? 'selected' : '' }}>Transfer Bank
                                            </option>
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group"><label>No Biaya</label><input type="text" class="form-control"
                                            value="{{ $biaya->custom_number ?? '[Auto]' }}" disabled></div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="tag">Tag</label>
                                        <input type="text" class="form-control" id="tag" name="tag"
                                            value="{{ old('tag', $biaya->tag) }}" readonly>
                                    </div>
                                    <div class="form-group">
                                ...
                                @foreach($items as $index => $item)
                                    ...
                                    <tr>
                                        <td><input type="text" class="form-control" name="kategori[]" value="{{ $oldKategori }}"
                                                placeholder="Contoh: Biaya Kantor" required></td>
                                        ...
                                        <td><input type="number" class="form-control text-right expense-amount" name="total[]"
                                                value="{{ $oldJumlah }}" placeholder="0" required></td>
                                        <td>
                    ...
                    @error('kategori.*') <div class="text-danger small mt-2">Error di baris Kategori: {{ $message }}</div>
                    @enderror
                    @error('total.*') <div class="text-danger small mt-2">Error di baris Jumlah: {{ $message }}</div>
                    @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('memo') is-invalid @enderror" id="memo" name="memo"
                                    rows="2">{{ old('memo', $biaya->memo) }}</textarea>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 50%;">
                                            <input type="number"
                                                ...
                                                value="{{ old('tax_percentage', $biaya->tax_percentage) }}" min="0"
                                                step="0.01">
